...
/**
 * 定义公共的DAO操作接口标准，基本功能包括
 *  增加、修改全部、删除数据，根据编号查询，查询全部，分页显示，数据统计
* @Title: IDAO.java
* @Package com.wcy.dao
* @author 晨阳 
* @date 2020年3月21日 下午7:33:23
* @Description: 
* @version V1.0
* 
...
public interface IDAO<K,V>{
	 ...
	 * @return 删除成功返回true（删除的数据的个数与要删除的数据个数相同）,否则返回false
	 * @throws Exception SQL 执行异常
	 */
	 ...
	 * 根据编号查询指定的信息
	 * @param id 要查询的编号
	 * @return 如果信息存在，则数据以VO类对象的形式返回，如果数据不存在，则返回null
	 * @throws Exception SQL 执行异常
	 */
	public V findById(K id) throws Exception;
	
	/**
	 * 查询指定数据表的全部记录，并且以结合的形式返回
